...
from app.screenplay.services.pipeline.element_extractor import ScreenplayElement
from app.screenplay.services.pipeline.fidelity_scorer import (
    FidelityInput,
    score_scene_fidelity,
)
from app.screenplay.services.pipeline.screenplay_optimizer import (
    OptimizeRequest,
    ScreenplayOptimizeError,
    optimize_screenplay,
)
from app.screenplay.services.pipeline.structure_analyzer import (
    StructureSceneInput,
    analyze_structure,
)

router = APIRouter(tags=["optimize"], dependencies=[Depends(get_current_user)])
